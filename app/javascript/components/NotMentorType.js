...
class NotMentorType extends React.Component { 
  ...
  <div>
    ...
    <div className="Polaris-Banner__Content" id="Banner5Content">
      ...
      <input onChange={this.onEmailPressed} id="Checkbox1" type="checkbox" className="Polaris-Checkbox__Input" name="email_check" aria-invalid="false" role="checkbox" aria-checked="false" value="1"/><div className="Polaris-Checkbox__Backdrop"></div><div className="Polaris-Checkbox__Icon"><span className="Polaris-Icon"><svg className="Polaris-Icon__Svg" viewBox="0 0 20 20"><g fillRule="evenodd"><path d="M8.315 13.859l-3.182-3.417a.506.506 0 0 1 0-.684l.643-.683a.437.437 0 0 1 .642 0l2.22 2.393 4.942-5.327a.437.437 0 0 1 .643 0l.643.684a.504.504 0 0 1 0 .683l-5.91 6.35a.437.437 0 0 1-.642 0"></path><path d="M8.315 13.859l-3.182-3.417a.506.506 0 0 1 0-.684l.643-.683a.437.437 0 0 1 .642 0l2.22 2.393 4.942-5.327a.437.437 0 0 1 .643 0l.643.684a.504.504 0 0 1 0 .683l-5.91 6.35a.437.437 0 0 1-.642 0"></path></g></svg></span></div></div></span><span className="Polaris-Choice__Label">Compose Email</span></label>
